...
router.post('/google', authLimiter, validateBody(schemas.google), authController.google)
router.post('/2fa/verify', authLimiter, validateBody(schemas.verify2FA), authController.verify2FA)
